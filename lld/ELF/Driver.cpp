...
static bool runQemuInAsmTrace(const std::string &, const std::string &) { return false; }

static bool makeRiscvNoplizedCandidate(const std::string &, const std::string &, const std::string &, bool = false) { return false; }
